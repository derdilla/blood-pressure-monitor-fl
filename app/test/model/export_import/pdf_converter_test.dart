...
void main() {
  test('should not return empty data', () async {
    ...
    final converter = PdfConverter(PdfExportSettings(), localizations, Settings(), ExportColumnsManager(), ExportSettings());
  ...
  test('generated data length should be consistent', () async {
    ...
    final converter = PdfConverter(PdfExportSettings(), localizations, Settings(), ExportColumnsManager(), ExportSettings());
    final pdf = await converter.create(createRecords());
    final converter2 = PdfConverter(PdfExportSettings(), localizations, Settings(), ExportColumnsManager(), ExportSettings());
  ...
  test('generated data should change on settings change', () async {
    ...
    final converter = PdfConverter(pdfSettings, localizations, Settings(), ExportColumnsManager(), ExportSettings());
