...
<p align="center">
  A versatile app for tracking, analysing and exporting blood pressure related data.
</p>

## Features

- Stable measurement storage
- Fast input through dialoge on launch and automatic form navigation
- Beautiful insights
- Versatile export (CSV, PDF, SQLite), granualy configurable
